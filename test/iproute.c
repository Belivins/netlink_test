	...
	while (argc > 0) {
		if (strcmp(*argv, "tos") == 0 ||
			...
			if (addr.bytelen){
				...
				printf("addr.data %u %u %u %u, addr.bytelen %d \n", 
					ip_addr.arr[0], ip_addr.arr[1], ip_addr.arr[2], ip_addr.arr[3], addr.bytelen);
			}
